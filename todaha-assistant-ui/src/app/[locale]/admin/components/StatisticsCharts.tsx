        ...
        <div className="px-6">
          <div className="flex items-center justify-between">
            <span className="font-medium">
              {t("AI Assistant - users interaction")}
            </span>
            <Tabs variant="boxed" size={"md"}>
              <Tab active={true}>{t("Last 30 days")}</Tab>
            </Tabs>
          </div>
          <div className="mt-2 border-y border-base-content/10  py-2">
            ...
            <span className="text-sm text-base-content/70">
              {t("Total number of messages in the last 30 days")}
            </span>
          </div>
        </div>
      ...
      <CardBody className="px-0 pb-0">
        <div className="px-6">
          ...
          <div className="mt-2 border-y border-base-content/10  py-2">
            ...
            <span className="text-sm text-base-content/70">
              {t("Total number of conversations in the last 30 days")}
            </span>
          </div>
        </div>
        <div className="overflow-hidden rounded-xl">
