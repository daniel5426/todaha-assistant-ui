...
const LoginPage = () => {
    ...
    return (
        <>
            ...
            <div className="flex min-h-full flex-col items-stretch p-6 lg:p-12" style={{ direction: isRTL? "rtl": "ltr"}}>
                <div className="flex items-center justify-between">
                    <Logo />
                    <ThemeToggle />
                </div>
                <div className="mx-auto flex w-full max-w-[400px] flex-1 flex-col justify-center mt-[30%]">
                    <h3 className="text-center text-xl font-semibold">{t("Login")}</h3>
